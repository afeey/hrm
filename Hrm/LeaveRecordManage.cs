...
namespace Hrm
{
    public partial class LeaveRecordManage : Form
    {
        ...
        public LeaveRecordManage()
        {
            InitializeComponent();
        }

        private void LeaveRecordManage_Load(object sender, EventArgs e)
        {
        ...
        /// </summary>
        /// <param name="id"></param>
        private void BindLeaveRecordList(int id)
        {
            dgvRecord.AutoGenerateColumns = false;
            dgvRecord.DataSource = rBll.GetLeaveRecordByEId(id);

            Employee e= eBll.GetEmployee(id);
            groupRecord.Text = e.EName + "(" + e.Code+ ")休假记录";
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            if (new AddLeaveRecord(currentId).ShowDialog() == DialogResult.OK)
            {
                BindLeaveRecordList(currentId);
            }
        }
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
             ...
             if (rows.Count > 0)
             {
                 ...
                 if (new UpdateLeaveRecord(id).ShowDialog() == DialogResult.OK)
                 {
                     BindLeaveRecordList(currentId);
                 }
             }
